    ...
    <main class="relative h-full max-h-screen transition-all duration-200 ease-in-out xl:ml-68 rounded-xl">
        ...
        <div class="w-full px-6 py-6 mx-auto">
          ...
          <div class="flex flex-wrap -mx-3">
            <!-- card1 -->
            <div class="w-full max-w-full p-4 px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4" style="width: 50%">
                ...
                <div class="flex-auto p-4">
                  <div class="flex flex-row -mx-3">
                    <div class="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase light:text-white light:opacity-60">Buku</p>
                        <h5 class="mb-2 font-bold light:text-white">{{ $buku_count }}</h5>
                    </div>
                </div>
              ...
              <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl light:bg-slate-850 light:shadow-light-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                  <div class="flex flex-row -mx-3">
                    <div class="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase light:text-white light:opacity-60">Peminjaman</p>
                        <h5 class="mb-2 font-bold light:text-white">{{ $peminjaman_count }}</h5>
                      </div>
                    </div>
                    <div class="px-3 text-right basis-1/3">
              ...
              <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl light:bg-slate-850 light:shadow-light-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                  <div class="flex flex-row -mx-3">
                    <div class="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase light:text-white light:opacity-60">User</p>
                        <h5 class="mb-2 font-bold light:text-white">{{ $users_count }}</h5>
            ...
            <!-- card4 -->
            <div class="w-full max-w-full p-4 px-3 sm:w-1/2 sm:flex-none xl:w-1/4" style="width: 50%">
              <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl light:bg-slate-850 light:shadow-light-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                  <div class="flex flex-row -mx-3">
                    <div class="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase light:text-white light:opacity-60">Kategori</p>
                        <h5 class="mb-2 font-bold light:text-white">{{ $kategori_count }}</h5>
                      </div>
                    </div>
                    <div class="px-3 text-right basis-1/3">
      ...
      <div fixed-plugin>
        ...
        <div fixed-plugin-card class="z-sticky backdrop-blur-2xl backdrop-saturate-200 light:bg-slate-850/80 shadow-3xl w-90 ease -right-90 fixed top-0 left-auto flex h-full min-w-0 flex-col break-words rounded-none border-0 bg-white/80 bg-clip-border px-2.5 duration-200">
          <div class="px-6 pt-4 pb-0 mb-0 border-b-0 rounded-t-2xl">
            <div class="float-left">
              <h5 class="mt-4 mb-0 light:text-white">Argon Configurator</h5>
              <p class="light:text-white light:opacity-80">See our dashboard options.</p>
            </div>
            <div class="float-right mt-6">
              <button fixed-plugin-close-button class="inline-block p-0 mb-4 text-sm font-bold leading-normal text-center uppercase align-middle transition-all ease-in bg-transparent border-0 rounded-lg shadow-none cursor-pointer hover:-translate-y-px tracking-tight-rem bg-150 bg-x-25 active:opacity-85 light:text-white text-slate-700">
                <i class="fa fa-close"></i>
              </button>
            </div>
            <!-- End Toggle Button -->
          </div>
          <hr class="h-px mx-0 my-1 bg-transparent bg-gradient-to-r from-transparent via-black/40 to-transparent light:bg-gradient-to-r light:from-transparent light:via-white light:to-transparent" />
          <div class="flex-auto p-6 pt-0 overflow-auto sm:pt-4">
            <!-- Sidebar Backgrounds -->
            <div>
              <h6 class="mb-0 light:text-white">Sidebar Colors</h6>
            </div>
            <a href="javascript:void(0)">
              <div class="my-2 text-left" sidenav-colors>
                ...
                <span class="py-2.2 text-xs rounded-circle h-5.6 mr-1.25 w-5.6 ease-in-out bg-gradient-to-tl from-zinc-800 to-zinc-700 light:bg-gradient-to-tl light:from-slate-750 light:to-gray-850 relative inline-block cursor-pointer whitespace-nowrap border border-solid border-white text-center align-baseline font-bold uppercase leading-none text-white transition-all duration-200 hover:border-slate-700" data-color="gray" onclick="sidebarColor(this)"></span>
            ...
            <!-- Sidenav Type -->
            <div class="mt-4">
              <h6 class="mb-0 light:text-white">Sidenav Type</h6>
              <p class="text-sm leading-normal light:text-white light:opacity-80">Choose between 2 different sidenav types.</p>
            </div>
            <div class="flex">
              <button transparent-style-btn class="inline-block w-full px-4 py-2.5 mb-2 font-bold leading-normal text-center text-white capitalize align-middle transition-all bg-blue-500 border border-transparent border-solid rounded-lg cursor-pointer text-sm xl-max:cursor-not-allowed xl-max:opacity-65 xl-max:pointer-events-none xl-max:bg-gradient-to-tl xl-max:from-blue-500 xl-max:to-violet-500 xl-max:text-white xl-max:border-0 hover:-translate-y-px light:cursor-not-allowed light:opacity-65 light:pointer-events-none light:bg-gradient-to-tl light:from-blue-500 light:to-violet-500 light:text-white light:border-0 hover:shadow-xs active:opacity-85 ease-in tracking-tight-rem shadow-md bg-150 bg-x-25 bg-gradient-to-tl from-blue-500 to-violet-500 hover:border-blue-500" data-class="bg-transparent" active-style>White</button>
              <button white-style-btn class="inline-block w-full px-4 py-2.5 mb-2 ml-2 font-bold leading-normal text-center text-blue-500 capitalize align-middle transition-all bg-transparent border border-blue-500 border-solid rounded-lg cursor-pointer text-sm xl-max:cursor-not-allowed xl-max:opacity-65 xl-max:pointer-events-none xl-max:bg-gradient-to-tl xl-max:from-blue-500 xl-max:to-violet-500 xl-max:text-white xl-max:border-0 hover:-translate-y-px light:cursor-not-allowed light:opacity-65 light:pointer-events-none light:bg-gradient-to-tl light:from-blue-500 light:to-violet-500 light:text-white light:border-0 hover:shadow-xs active:opacity-85 ease-in tracking-tight-rem shadow-md bg-150 bg-x-25 bg-none hover:border-blue-500" data-class="bg-white">light</button>
            </div>
            <p class="block mt-2 text-sm leading-normal light:text-white light:opacity-80 xl:hidden">You can change the sidenav type just on desktop view.</p>
            <!-- Navbar Fixed -->
            <div class="flex my-4">
              <h6 class="mb-0 light:text-white">Navbar Fixed</h6>
            ...
            <div class="w-full text-center">
              ...
              <h6 class="mt-4 light:text-white">Thank you for sharing!</h6>
