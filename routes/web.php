...
Route::middleware(['auth', 'UserAccess:petugas'])->group(function () {
    ...
    Route::post('/petugas/peminjaman/{id}/reject', [PetugasPeminjamanController::class, 'reject'])->name('petugas.peminjaman.reject');
...
Route::middleware(['auth', 'UserAccess:peminjam'])->group(function () {
    ...
    Route::post('/favorite/{id}', [FavoriteController::class, 'store'])->name('store');
    Route::delete('/favorite/delete/{id}', [FavoriteController::class, 'destroy'])->name('destroy');
});
